...
export class VoucherServiceBase {
  ...
  async count(args: Omit<Prisma.VoucherCountArgs, "select">): Promise<number> {
  ...
  async vouchers<T extends Prisma.VoucherFindManyArgs>(
    ...
    return this.prisma.voucher.findMany<Prisma.VoucherFindManyArgs>(args);
  }
  ...
  async getTombola(parentId: string): Promise<PrismaTombola | null> {
